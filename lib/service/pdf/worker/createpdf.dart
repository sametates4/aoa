...
createPDF(List<Worker> model, int kisi, int gider) async {
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("İsim",style: pw.TextStyle(font: font)),
              ],
            ),
          ),
          Container(
          ...
          Container(
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("T. Ücret",style: pw.TextStyle(font: font)),
              ],
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Ç. Gün",style: pw.TextStyle(font: font)),
              ],
            ),
          ),
          Container(
...
Widget total(font, kisi, gider){
  return Row(
      ...
      children: [
        Column(
            children: [
              Text("Toplam Çalışan kişi: $kisi", style: TextStyle(font: font)),
              Text("Toplam Ödenecek Tutar: $gider", style: TextStyle(font: font)),
              Divider(),
            ]
        )
      ]
